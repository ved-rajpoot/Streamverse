    ...
    <>
      {
        ...
        return (
                <div className="mb-2 shadow-xl flex flex-row justify-center w-[100%] bg-white cursor-pointer" onClick={()=>navigate(`/app/:userId/profile/playlist/video/${playlist._id}`, {state: {props:{name:playlist.name}}})}>
