...
import { useNavigate } from "react-router-dom";
  ...
  export default function VideoCard(props) {
    ...
    return (
      <Card className="w-96 mx-10 my-10 border-gray-300 border-b-4 hover:bg-gray-100 duration-100 cursor-pointer" onClick={()=>{navigate(`/dashboard/${cloudinary_id}`, {state: {props:{id, avatar,description,title}}})}}>
